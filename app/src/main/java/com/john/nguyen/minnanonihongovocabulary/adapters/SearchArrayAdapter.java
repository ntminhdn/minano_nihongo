...
public class SearchArrayAdapter extends ArrayAdapter<Vocabulary> {
    ...
    public SearchArrayAdapter(Context context, int resource, ArrayList<Vocabulary> vocabularies, String language) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            viewHolder.tvLesson = (TextView)convertView.findViewById(R.id.tvLesson);
        ...
        viewHolder.tvLesson.setText(String.valueOf(vocabulary.getLesson() + 1));
